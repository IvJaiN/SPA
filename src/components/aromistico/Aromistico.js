        ...
        <>
            ...
            <div className="about-coffee">
                ...
                <div className="about-coffee_right">
                    ...
                    <p className="about-coffee__country"><span>Country</span>: Brasil</p>
                    ...
                    <p className="about-coffee__price">Price:  <span>16.99$</span></p>
                </div>
            </div>
            <Footer/>
        </>
